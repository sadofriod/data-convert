...
function App() {
  ...
  const isDisable = (key: string, isSource: boolean) => {
    ...
    if (isSource) {
      return Array.isArray(calc[currentCalcKey].sourceKey)
        ? calc[currentCalcKey].sourceKey.includes(key)
        : key === calc[currentCalcKey].sourceKey;
    } else {
      return Array.isArray(calc[currentCalcKey].targetKey)
        ? calc[currentCalcKey].targetKey.includes(key)
        : key === calc[currentCalcKey].targetKey;
    }
  };
